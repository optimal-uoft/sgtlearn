...
public:
  ...
  virtual PredictT predict(const SplitCandidate &split) = 0;
  ...
  virtual const std::vector<StatsT> &getStats(const SplitCandidate &split);
...
protected:
  ...
  void fillIntervalMeta(SplitCandidate &split) const;

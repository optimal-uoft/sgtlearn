 ...
 */
void initAssignmentsWeightedKMeans(const arma::mat &X, const arma::vec &w,
...
void initBinAssignmentsForCd(bool smartInit,
...
bool partitionSizesOk(const std::vector<size_t> &assignments,
...
void evaluateDiscriminator(
    ...
    size_t numPartitions, const CoordinateDescentParams &cd,
    double parentImp, double branchingPenalty, double outerMinImpurityDecrease,
    size_t outerMinLeaf, double eps, double &bestObjective,
